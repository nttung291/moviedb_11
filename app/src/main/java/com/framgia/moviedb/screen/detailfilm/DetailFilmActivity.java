...
public class DetailFilmActivity extends AppCompatActivity implements DetailFilmContract.View,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewRate = findViewById(R.id.text_rate_detail);
        mTextViewDate = findViewById(R.id.text_date_detail);
    ...
    void initUI() {
        mTextViewDate.setText(Constant.REALEASE_DATE + Utils.dateFormat(mMovie.getReleaseDate()));
        mTextViewRate.setText(Constant.RATE_IMDB + mMovie.getVoteAverage());
