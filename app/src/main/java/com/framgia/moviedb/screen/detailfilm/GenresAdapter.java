...
public class GenresAdapter extends BaseRecyclerViewAdapter<GenresAdapter.ViewHolder> {
    private ArrayList<Genres> mGenres = new ArrayList<>();
    private ItemGenresClickListener mItemGenresClickListener;
    private LayoutInflater mLayoutInflater;

    public GenresAdapter(Context context, ItemGenresClickListener itemClickListener) {
        super(context);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView,final ItemGenresClickListener itemGenresClickListener) {
            super(itemView);
            textViewGenres = itemView.findViewById(R.id.text_detail_item);
